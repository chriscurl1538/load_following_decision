...
def main():
    ...
    #
    # payback_test_25 = sa_payback_model(thermal_cost_new=elf_thermal_cost_total,
    #                                    electrical_cost_new=elf_electric_cost_new,
    #                                    tes_size=tes_size_elf, pct_incentive=0.25)
    #
    # payback_test_50 = sa_payback_model(thermal_cost_new=elf_thermal_cost_total,
    #                                    electrical_cost_new=elf_electric_cost_new,
    #                                    tes_size=tes_size_elf, pct_incentive=0.5)
    #
    # print(payback_test_25)
    # print(payback_test_50)
    ...
    #     }
    #
    #     param_values = saltelli.sample(problem, 1024)    # TODO: Consider best sample size value (~1050)
    #
