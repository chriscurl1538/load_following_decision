...
def calc_excess_and_deficit_heat(chp=None, demand=None, load_following_type=None):
    """
    ...
    if chp is not None and demand is not None:
        ...
        if load_following_type is "ELF":
            ...
            chp_heat_gen_hourly = cogen.tlf_calc_hourly_heat_generated(chp=chp, demand=demand)
        else:
...
def calc_tes_heat_flow_and_soc(chp=None, demand=None, tes=None, load_following_type=None):
    """
