...
def calc_excess_and_deficit_chp_heat_gen(chp_gen_hourly_kwh_dict=None, chp=None, demand=None, ab=None, load_following_type=None):
    """
    ...
    if any(elem is None for elem in [chp, demand, ab, load_following_type]) is False:
        ...
        if load_following_type is "PP":
            chp_heat_gen_hourly = cogen.pp_calc_hourly_heat_generated(chp_gen_hourly_kwh=chp_gen_hourly_kwh_dict["PP"], chp=chp, demand=demand, ab=ab)
        elif load_following_type is "ELF":
            chp_heat_gen_hourly = cogen.elf_calc_hourly_heat_generated(chp_gen_hourly_kwh=chp_gen_hourly_kwh_dict["ELF"], chp=chp, demand=demand, ab=ab)
...
def calc_tes_heat_flow_and_soc(chp_gen_hourly_kwh_dict=None, tes_size=None, chp=None, demand=None, tes=None, ab=None, load_following_type=None):
    """
