...
def calc_excess_and_deficit_chp_heat_gen(chp=None, demand=None, ab=None, load_following_type=None):
    ...
    if any(elem is None for elem in [chp, demand, ab, load_following_type]) is False:
        ...
        if load_following_type is "PP":
            chp_heat_gen_hourly = cogen.pp_calc_hourly_heat_generated(chp=chp, demand=demand, ab=ab)
...
def calc_tes_heat_flow_and_soc(chp_size=None, chp=None, demand=None, tes=None, ab=None, load_following_type=None):
    """
    ...
    """
    if any(elem is None for elem in [chp, demand, ab, load_following_type]) is False:
        tes_size = sizing.size_tes(chp_size=chp_size, demand=demand, chp=chp, ab=ab, load_following_type=load_following_type)
