...
def plot_electric(chp=None, demand=None):
    data1 = cogen.calc_electricity_bought_and_generated(chp=chp, demand=demand)[1]  # generation
    data2 = cogen.calc_electricity_bought_and_generated(chp=chp, demand=demand)[0]  # bought
...
def plot_thermal(chp=None, demand=None, tes=None, ab=None):
    ...
    fig.suptitle('Annual Thermal Demand and Generation, Daily [Btu]')
