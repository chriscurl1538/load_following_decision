...
def calc_electricity_bought_and_generated(chp=None, demand=None):
    """
    ...
    Also calculates electricity generated by the mCHP unit each hour
...
def calc_annual_electric_cost(chp=None, demand=None):
    ...
    if demand is not None:
        ...
        total_bought = sum(calc_electricity_bought_and_generated(chp=chp, demand=demand)[0])
...
def calc_hourly_heat_generated(chp=None, demand=None):
    ...
    if chp is not None and demand is not None:
        ...
        electricity_generated = calc_electricity_bought_and_generated(chp=chp, demand=demand)[1]
        hourly_heat = []
